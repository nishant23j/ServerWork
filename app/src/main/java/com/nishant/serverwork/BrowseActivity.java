...
public class BrowseActivity extends AppCompatActivity implements View.OnClickListener  {
    ...
    private String UPLOAD_URL ="http://nishant23j.hol.es/VolleyUpload/upload.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonUpload = (Button) findViewById(R.id.uploadfull);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        //Showing toast
                        Toast.makeText(BrowseActivity.this, "Network Error Try other image!!!", Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
